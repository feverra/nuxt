<template>
      ...
      <v-row>
        ...
        <v-col>
          <v-form>
            ...
            <v-text-field v-model="form.lastname" label="Lastname" dense required></v-text-field>
            <div class="gender-group d-flex mt-3">
              <p>Gender</p>
              <div class="circle" :class="form.gender == 1 ?'active':''" @click="form.gender = 1">
                <svg
  ...
  .a {
    fill: #fff;
              ...
              <p>Male</p>
              <div class="circle" :class="form.gender == 2 ?'active':''" @click="form.gender = 2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24.313"
                  height="24.313"
  ...
  .a {
    fill: #fff;
            ...
            <v-btn rounded color="primary" class="w-100 mt-8 my-btn" @click="next">Next</v-btn>
          </v-form>
        </v-col>
      </v-row>
    </v-container>
